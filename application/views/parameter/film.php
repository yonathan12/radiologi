  ...
  <div class="card-body">
    <table id="example1" class="table table-bordered table-striped">
      ...
      <tr>
        ...
        <a href="<?= base_url('film/delete/'.$val['id']); ?>" class="btn btn-sm btn-danger hapusUser" >Hapus</a>
        </td>
      </tr>
      <?php }?>
      </tbody>
...
<div class="modal fade" id="tambahUser" tabindex="-1" role="dialog" aria-labelledby="tambahUserLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url();?>film/create" method="POST">
      <div class="modal-body">
      <input type="text" class="form-control" id="name" name="descr" placeholder="Ukuran Film" required oninvalid="this.setCustomValidity('Ukuran Wajib Diisi')">
...
<div class="modal fade" id="editUser<?= $id; ?>" tabindex="-1" role="dialog" aria-labelledby="editUserLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="text" class="form-control" id="nameEdit<?= $id; ?>" name="descr" placeholder="Ukuran Film" value="<?= $ukuran; ?>" required oninvalid="this.setCustomValidity('Ukuran Wajib Diisi')">
